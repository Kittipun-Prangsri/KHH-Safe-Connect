            ...
            contents: [
              {
                ...
                contents: [
                  ...
                  {
                    type: 'text',
                    text: '• เกณฑ์ 2 สัปดาห์: ย้อนนึกถึงความรู้สึกใน 14 วันที่ผ่านมาเท่านั้น ไม่ใช่ความรู้สึกชั่ววูบวันนี้',
                    size: 'xs',
                    color: '#1E3A8A',
                    margin: 'xs',
                    wrap: true,
                  ...
                  {
                    type: 'text',
                    text: '• ความถี่: ไม่มีเลย | บางวัน (1-7 วัน) | บ่อย (>7 วัน) | เกือบทุกวัน',
                    size: 'xs',
                    color: '#1E3A8A',
                    margin: 'xs',
                    wrap: true,
              ...
              },
              {
                ...
                contents: [
                  ...
                  {
                    type: 'text',
                    text: '• ไม่ใช่การวินิจฉัยโรค: เป็นการคัดกรองเบื้องต้น การวินิจฉัยต้องทำโดยจิตแพทย์/นักจิตวิทยา',
                    size: 'xs',
                    color: '#991B1B',
                    margin: 'xs',
                    wrap: true,
                  ...
                  {
                    type: 'text',
                    text: '• อารมณ์เศร้าตามธรรมชาติ: การสูญเสียสิ่งสำคัญทำให้คะแนนสูงชั่วคราวได้',
                    size: 'xs',
                    color: '#991B1B',
                    margin: 'xs',
                    wrap: true,
                  ...
                  {
                    type: 'text',
                    text: '🚨 คิดทำร้ายตนเอง: หากมีข้อคำถามถึงความคิดอยากตาย แล้วตอบว่า "มี" ควรรีบขอความช่วยเหลือทันที!',
                    size: 'xs',
                    color: '#DC2626',
                    weight: 'bold',
                    margin: 'sm',
        ...
        },
        {
          ...
          header: {
            ...
            contents: [
              {
                type: 'text',
                text: '🧘 การผ่อนคลาย & ติดต่อช่วยเหลือ (2/2)',
                color: '#FFFFFF',
                size: 'md',
                weight: 'bold',
                wrap: true,
              ...
              {
                type: 'text',
                text: 'โรงพยาบาลคลองหาด & สายด่วน 24 ชั่วโมง',
                color: '#DDD6FE',
                size: 'xs',
                margin: 'xs',
              },
            ...
            contents: [
              {
                ...
                contents: [
                  {
                    type: 'text',
                    text: '🧘 คำแนะนำผ่อนคลายความเครียด & การนอน',
                    size: 'xs',
                    color: '#6B21A8',
                    weight: 'bold',
                  },
                  {
                    type: 'text',
                    text: '• ความเครียดกระตุ้นฮอร์โมน Cortisol ทำให้น้ำตาลและความดันสูงขึ้น',
                    size: 'xs',
                    color: '#581C87',
                    margin: 'xs',
                    wrap: true,
                  ...
                  {
                    type: 'text',
                    text: '• ฝึกหายใจลึก 4-4-6 และปฏิบัติตาม Sleep Hygiene (เข้านอนตรงเวลา งดจอก่อนนอน 30 นาที)',
                    size: 'xs',
                    color: '#581C87',
                    margin: 'xs',
                    wrap: true,
              ...
              },
              {
                ...
                contents: [
                  {
                    type: 'text',
                    text: '📞 งานสุขภาพจิตและยาเสพติด รพ.คลองหาด',
                    size: 'xs',
                    color: '#5B21B6',
                    weight: 'bold',
                  },
              ...
              },
              {
                ...
                contents: [
                  {
                    type: 'text',
                    text: '🚨 สายด่วนสุขภาพจิต โทรฟรี 24 ชั่วโมง',
                    size: 'xs',
                    color: '#B91C1C',
                    weight: 'bold',
                  },
