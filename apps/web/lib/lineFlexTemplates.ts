        ...
        contents: [
          {
            ...
            contents: [
              ...
              {
                type: 'text',
                text: '• ตอบตามความจริง: ซื่อสัตย์กับความรู้สึกตนเอง ห้ามลดทอนหรือเพิ่มระดับความรุนแรงของอาการ',
                size: 'xs',
                color: '#1E3A8A',
                margin: 'xs',
                wrap: true,
          ...
          },
          {
            ...
            contents: [
              {
                type: 'text',
                text: '🧘 คำแนะนำผ่อนคลายความเครียด & การนอนหลับ',
                size: 'xs',
                color: '#6B21A8',
                weight: 'bold',
              },
              ...
              {
                type: 'text',
                text: '• ฝึกหายใจลึก 4-4-6 และปฏิบัติตามสุขอนามัยการนอน (เข้านอนตรงเวลา งดจอก่อนนอน 30 นาที)',
                size: 'xs',
                color: '#581C87',
                margin: 'xs',
                wrap: true,
